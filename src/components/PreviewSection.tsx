...
import { BreakpointKey, SpacingBreakpoint, TypographySettings } from '../types';
...
export const PreviewSection: React.FC<PreviewSectionProps> = ({
  ...
  const SectionPadding: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <div 
      ...
      >
        ...
        <div style={{ marginTop: `${s.majorSections}px` }}>
          <div className="bg-green-50 rounded border-l-4 border-green-500">
            <SectionPadding>
              <div style={getTypographyStyles(typography, 'p2')} className="font-medium text-green-700 mb-0">Section Label</div>
              ...
              <div style={{ marginTop: `${s.h2ToNext}px` }}>
                ...
                <div style={{ marginTop: `${s.h3ToContent}px` }}>
                  ...
                  <div style={{ marginTop: `${s.h3ToContent}px` }}>
                    <ul className="space-y-0" style={getTypographyStyles(typography, 'p1')}>
        ...
        <div style={{ marginTop: `${s.subsections}px` }}>
          <div className="bg-green-50 rounded border-l-4 border-green-500">
            <SectionPadding>
              <h2 style={getTypographyStyles(typography, 'h2')} className="mb-4">
                Content + Image Layout
              </h2>
              
              <div>
                <p style={getTypographyStyles(typography, 'p2')} className="text-gray-600 mb-3">
                ...
                >
                  <div>
                    <h2 style={getTypographyStyles(typography, 'h2')} className="mb-3">
                      About Our Service
                    </h2>
                    <p style={getTypographyStyles(typography, 'p1')} className="mb-4">
                  ...
                  <div className="bg-gray-200 rounded flex items-center justify-center" style={{ minHeight: '120px' }}>
                    <span style={getTypographyStyles(typography, 'p2')} className="text-gray-500">Image Placeholder</span>
                  </div>
                </div>
              </div>
            </SectionPadding>
        ...
        <div style={{ marginTop: `${s.subsections}px` }}>
          <div className="bg-orange-50 rounded border-l-4 border-orange-500">
            <SectionPadding>
              ...
              {/* 2 Column Grid */}
              <div className="mb-4">
                <h3 style={getTypographyStyles(typography, 'h3')} className="mb-2">
                ...
                >
                  <div className="bg-gray-200 p-3 rounded text-center" style={getTypographyStyles(typography, 'p1')}>Item 1</div>
                  <div className="bg-gray-200 p-3 rounded text-center" style={getTypographyStyles(typography, 'p1')}>Item 2</div>
                  <div className="bg-gray-200 p-3 rounded text-center" style={getTypographyStyles(typography, 'p1')}>Item 3</div>
                  <div className="bg-gray-200 p-3 rounded text-center" style={getTypographyStyles(typography, 'p1')}>Item 4</div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                >
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 1</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 2</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 3</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 4</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 5</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>Item 6</div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>1</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>2</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>3</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>4</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>5</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>6</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>7</div>
                  <div className="bg-gray-200 p-2 rounded text-center" style={getTypographyStyles(typography, 'p2')}>8</div>
                </div>
              </div>
            </SectionPadding>
          </div>
            ...
            <SectionPadding>
              ...
              >
                <div className="bg-gray-100 p-4 rounded border-2 border-dashed border-gray-300">
                  <p style={getTypographyStyles(typography, 'p2')} className="text-gray-600 mb-2">
